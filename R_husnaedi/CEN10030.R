...
## undirbúningur fyrir ensku útgáfuna: (enska útgáfan er ekki til af þessari töflu, 
## þarf að þýða sjálfur)
url.en <- url.is
...
dalkar.meta <- tibble(
  dalkanofn_cd = c('eignarhald', 'tegund_ibudar', paste(tafla_id, 'gildi', sep ='_')),
